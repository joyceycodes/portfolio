    ...
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method="POST" action="https://getform.io/f/0090e051-4819-424e-b7ca-e456ff5b9538" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                ...
                <p className='text-gray-300 p-4'>Submit the form below or send me an email at joyceyu96@gmail.com</p>
            </div>
            ...
            <button className='text-white border-2 hover:bg-pink-600 hover:border-pink-600 px-3 py-4 my-8 mx-auto flex items-center'>Let's collaborate</button>
        </form>
    </div>
  )
}
