...
const Home = () => {
  return (
    <div name='home' className='bg-[#232946] w-full h-screen'>
      {/* container */}
      <div className='max-w-[1100px] mx-auto px-8 flex flex-col justify-center h-full'>
        <div className='max-w-[1100px] w-full grid sm:grid-cols-2 gap-8 px-4 mt-4'>
          <div>
              ...
              <br></br>
              <h2 className='text-4xl md:text-7xl text-[#b8c1ec]'>I'm a</h2>
              <h2 className='text-4xl md:text-7xl text-[#b8c1ec]'>Full Stack Software Developer.</h2>
              <p className='text-white py-4 max-w-700px font-bold'>San Francisco, CA</p>
                <div>
                <Link to="work" smooth={true} duration={500}> 
                    <button className='bg-[#eebbc3] text-[#232946] group  px-6 py-3 my-2 flex items-center hover:font-bold'>
                        View Work
